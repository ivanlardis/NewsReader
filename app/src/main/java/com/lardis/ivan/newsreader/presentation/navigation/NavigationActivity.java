...
import com.lardis.ivan.newsreader.presentation.full_news.LTechFullNewsFragment;
        ...
        protected Fragment createFragment(final String screenKey, final Object data) {
            switch (screenKey) {
                case NavigationScreens.NEWS:
                    return LTechNewsFragment.newInstance();
                case NavigationScreens.FULL_NEWS:
                    return LTechFullNewsFragment.newInstance(data);
                default:
                    return LTechNewsFragment.newInstance();
            }
        }
